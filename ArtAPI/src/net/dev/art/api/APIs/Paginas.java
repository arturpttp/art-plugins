...
public class Paginas {
	...
	public static HashMap<UUID, Paginas> users = new HashMap<UUID, Paginas>();

	// Running this will open a paged inventory for the specified player, with the
	// items in the arraylist specified.
	public Paginas(ArrayList<ItemStack> items, String name, Player p) {
	...
	public static final String nextPageName = "§aAvançar para proxima pagina";
	public static final String previousPageName = "§cVoltar para ultima pagina";
