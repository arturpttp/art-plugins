...
import me.micael.atributos.manager.StorageAPI.Storable;
import me.micael.atributos.manager.StorageAPI.Variable;
...
public final class Mine {
	...
	public static enum Chat {
		NORMAL("Â§A", "Â§2"), ERROR("Â§C", "Â§4"), SIMPLE("Â§7", "Â§8"), GAME("Â§E", "Â§6"),
		SETUP("Â§B", "Â§3"), BONUS("Â§9", "Â§1"), EFFECT("Â§D", "Â§5"), EXTRA("Â§F", "Â§0");
...
//			if ((Bukkit.getServer() instanceof CraftServer)) {
			java.lang.reflect.Field field = serverClass.getDeclaredField("commandMap");
...
//			}
	...
	/**
	 * Controlador de Tempo, classe que controla e ajuda na criaÃ§Ã£o de
	 * temporarizador (Timer)<br>
	 * , de atrasador (Delayer) que sÃ£o Tarefa de Tempo (Task ou BukkitTask)
	 * 
	 * @author Eduard-PC
	 *
	 */
	public static class TimeManager extends EventsManager implements Runnable {
		...
		/**
		 * Tempo anterior para fazer a comparaÃ§Ã£o
		 */
	...
	public static void sendActionBar(Player player, String text) {
		...
		try {
			...
			Bukkit.getConsoleSender().sendMessage(
					"Â§bRexAPI Â§aNao foi possivel usar o 'setActionBar' pois o servidor esta na versao anterior a 1.8");
	...
	public static void changeName(Player player, String displayName) {
		...
		try {
			...
			// EntityHuman b;
			java.lang.reflect.Field profileField = Extra.getField(Mine.claz_mEntityHuman, "bH");
	...
	/**
	 * Salva um Objecto no Arquivo em forma de serializaÃ§Ã£o Java
	 * 
	 ...
	 * 
	 * @param zipIn    Input Stream (ConeÃ§Ã£o de Algum Arquivo)
	...
	/**
	 * Efeito a fazer na localizaÃ§Ã£o
	 * 
	 * @author Eduard
	 *
	 */
	...
	/**
	 * Ponto de direÃ§Ã£o usado para fazer um RADAR
	 * 
	 * @author Eduard
	 *
	 */
	...
	public static abstract class Cooldowns {
		...
		/**
		 * Metodo abstrato para oque vai acontecer quando comeÃ§ar o Cooldown
		 * 
		 * @param player Jogador
		 */
	 ...
	 * O inv.remove(...) tambÃ©m remove porem remove qualquer item nÃ£o
	 * importanto nome, descriÃ§Ã£o, encantamentos
	 * 
	 * @param inventory Inventario
	 * @param item      Item
	 */
